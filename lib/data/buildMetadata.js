export function buildMetadata(displaySet) {
    ...
    const hightBit = displaySet.images[0]._instance.highBit;
    const photometricInterpretation = displaySet.images[0]._instance.photometricInterpretation;
    const pixelRepresentation = displaySet.images[0]._instance.pixelRepresentation;
