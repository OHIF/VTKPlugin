 ...
 * @returns {number}
 */
export function computeZoomPercentage(spacing,sliceMode,renderer,bounds){
    const sliceDiagonal = computeDiagonal(spacing,sliceMode,renderer,bounds);
    const imageDiagonal = computeImageDiagonal(spacing,sliceMode,renderer,bounds);
