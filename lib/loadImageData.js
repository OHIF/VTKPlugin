...
export function loadImageData(imageDataObject, callbacks) {
    return loadImageDataProgressively(imageDataObject.imageIds, imageDataObject.vtkImageData, imageDataObject.metaDataMap, imageDataObject.zAxis,callbacks).then(() => {
